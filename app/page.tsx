...
const Home = () => {
  return (
    <main className='w-screen h-screen relative'>
      ...
      >
        <div className='pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]'>
          ...
          <p className='text-gray-200 hidden md:block'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut dolore nulla suscipit? Dolores voluptates nemo
            tempora!
          </p>
      ...
      <div className='asbolute flex bottom-10 z-[20] right-5 flex-col md:hidden gap-5'>
        <Link
          href='/my-skills'
